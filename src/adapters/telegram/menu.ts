...
export const CALLBACK_FINANCIAL_SUMMARY = 'cmd:financial_summary';
...
export function financialSummaryUsageText(): string {
  return 'Cú pháp: /summary\nDùng /report <thời gian> để xem báo cáo theo tháng.';
}
...
export function quickMenuKeyboard(): InlineKeyboard {
  return [[{ text: 'Tổng quan tài chính', data: CALLBACK_FINANCIAL_SUMMARY }], [{
    text: 'Báo cáo tháng',
...
export function startKeyboard(): InlineKeyboard {
  return [[{ text: 'Menu', data: CALLBACK_MENU }, {
    text: 'Tổng quan',
    data: CALLBACK_FINANCIAL_SUMMARY,
  }, { text: 'Báo cáo', data: CALLBACK_REPORT }], [{
    text: 'Trợ giúp',
    data: CALLBACK_HELP,
  }]];
}
